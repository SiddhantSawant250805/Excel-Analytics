...
const AdminDashboard = () => {
  ...
  const fetchAdminStats = async () => {
    try {
      const response = await axios.get('https://excel-analytics-new.onrender.com/api/admin/stats');
  ...
  const fetchUsers = async () => {
    ...
    try {
      const response = await axios.get('https://excel-analytics-new.onrender.com/api/admin/users');
  ...
  const handleBlockUser = async (userId, isBlocked) => {
    try {
      await axios.patch(`https://excel-analytics-new.onrender.com/api/admin/users/${userId}/block`, { isBlocked: !isBlocked });
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      await axios.delete(`https://excel-analytics-new.onrender.com/api/admin/users/${userId}`);
