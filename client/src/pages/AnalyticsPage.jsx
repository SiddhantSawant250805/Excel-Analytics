...
const AnalyticsPage = () => {
  ...
  const logAnalytics = async (action, details = {}) => {
    try {
      await axios.post('https://excel-analytics-new.onrender.com/api/analytics/log', {
  ...
  const fetchUploadData = async () => {
    try {
      const response = await axios.get(`https://excel-analytics-new.onrender.com/api/upload/${id}`);
  ...
  const generateChart = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://excel-analytics-new.onrender.com/api/analytics/chart-data/${id}`, {
        params: {
      ...
      await axios.post('https://excel-analytics-new.onrender.com/api/chart-analytics', {
        uploadId: id,
  ...
  const generateInsights = async () => {
    ...
    try {
      const response = await axios.post('https://excel-analytics-new.onrender.com/api/insights/generate', {
        config: {
