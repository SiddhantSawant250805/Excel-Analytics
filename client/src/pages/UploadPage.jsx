...
const UploadPage = () => {
  ...
  const fetchUploadHistory = async () => {
    try {
      const response = await axios.get('https://excel-analytics-new.onrender.com/api/upload/history');
  ...
  const onDrop = useCallback(async (acceptedFiles) => {
    ...
    try {
      ...
      const response = await axios.post('https://excel-analytics-new.onrender.com/api/upload', formData, {
        headers: {
  ...
  const handleDelete = async (uploadId) => {
    ...
    try {
      await axios.delete(`https://excel-analytics-new.onrender.com/api/upload/${uploadId}`);
